      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="glass-panel border border-white/10 p-6 sm:p-8 rounded-3xl shadow-2xl flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-3 w-full md:w-auto">
            <Link 
              to="/book-service" 
              className="flex-1 md:flex-none flex items-center justify-center gap-2 text-[#050505] font-bold px-6 py-3 rounded-xl shadow-lg hover:shadow-accent/25 transition-all active:scale-95 text-xs sm:text-sm"
              style={{ background: 'linear-gradient(135deg, #d4af37, #b7791f)' }}
            >
              <PlusCircle size={16} /> Book Service
            </Link>
            <button
